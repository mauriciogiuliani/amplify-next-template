        ...
        <section id="duvidas"
            ...
            <div className="container mx-auto ">
                ...
                <div className="flex items-center">
                    ...
                    <Typography variant="h2" className="text-3xl font-bold tracking-tighter text-primary sm:text-5xl xl:text-5xl/none text-center lg:text-start">
                        Dúvidas Frequentes
                    </Typography>
                ...
                <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                    <AccordionHeader
                        className="text-gray-500 hover:text-secondary font-light min-h-[5rem]"
